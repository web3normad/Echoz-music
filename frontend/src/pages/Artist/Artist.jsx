        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-4 gap-6">
              <div className="bg-[#252727] p-6 rounded-xl flex items-center space-x-4">
            ...
            {/* Streaming Analytics */}
            <div className="bg-[#252727] rounded-lg shadow-lg p-6">
              <h3 className="text-xl font-bold text-[#04e3cb] mb-4">Streaming Analytics</h3>
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={artistData.streamCounts}>
                  ...
                  />
                  <Bar dataKey="streams" fill="#04e3cb" barSize={30} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
